...
Default model is ``yolo26s`` (YOLO v26 small) which offers better
detection accuracy for thin objects like knives compared to the nano
variant, at the cost of ~2x inference time.
"""
