...
STORIES = {
    "three_little_pigs": """
        [STORY] Once upon a time, there were three little pigs. [HAPPY] They set out to build their own houses! 
        ...
        [HAPPY] But when he came to the brick house... he huffed, and he puffed... but he could not blow it down! 
        The three little pigs lived happily ever after in the strong brick house.
    """,
    "goldilocks": """
        [STORY] Once upon a time, there was a little girl named Goldilocks. She went for a walk in the forest. 
